...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in greeting_service_pb2_grpc.py depends on'
...
def add_GreetingServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.example.grpc.GreetingService', rpc_method_handlers)
